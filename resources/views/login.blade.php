@extends("default")
    ...
    <div class="five wide computer ten wide mobile column">
      <h1 style="color:lightcoral">Login</h1>
      ...
      <form method="post" action="{{route('user.login')}}" class="ui form" id="signup" onsubmit="return validate()">
        {{csrf_field()}}
        <div class="field">
