@extends('default')
  @section("content")
    ...
    <section class="ui one column centered grid">
      <div class="six wide computer twelve wide mobile column" style="min-height:500px">
        <h1>Pesquisa</h1>
        @include('includes.messages')
        <form class="ui form" method="POST" action="{{route('search.key')}}">
          {{csrf_field()}}
          <div class="ui action input field" style="width:90%">
            <input type="text" name="keyword" placeholder="Palavras chave...">
